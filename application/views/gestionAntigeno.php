...
<base href="consulta">
  ...
  <title>SBCMedic | Gestión Antígeno</title>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light bg_transparent" style="height: 100px;">
    ...
    <ul class="navbar-nav h-100 align-items-center">
      ...
      <li class="nav-item" style=";">
        <span style="vertical-align:middle;"><span style="margin-left: 10px;font-size: 2.4rem;font-weight:bold;color: #004663;vertical-align:middle;  "> Gestión Antígeno<span></span>
      </li>
    </ul>
  ...
  <div class="content-wrapper" style="background: transparent;">
    ...
    <section class="content">
     ...
     <div class="col-md-2 text-center"></div>
      ...
      <span style="vertical-align:middle;  "><a href="<?php echo base_url('gestionPaciente');?>" style="height: auto;" target="_blank"></span> <span  class="btn btn-info w-50 mt-2 text-left" style="padding-left:30px;padding-right:10px;z-index:1;font-size: 2rem;font-weight:bold;color: #fff;vertical-align:middle;  "> Registrar Antígeno<span></a>
      </div>      
      <div class="col-md-2 text-center"></div>
     </div>
     <div class="row w-100 h-100 align-items-center" style="margin-bottom: 20px;">
     <div class="col-md-2 text-center"></div>
      <div class="col-md-8 text-center">
      <span style="vertical-align:middle;"><a href="<?php echo base_url('gestionBuscarPaciente-new');?>" style="height: auto;" target="_blank"> </span> <span  class="btn btn-secondary w-50 mt-2 text-left" style="padding-left:30px;padding-right:10px;z-index:1;font-size: 2rem;font-weight:bold;color: #fff;vertical-align:middle;"> Resumen Antígeno<span></a>
     ...
     <div class="col-md-2 text-center"></div>
      <div class="col-md-8 text-center">
      <span style="vertical-align:middle;  "><a href="<?php echo base_url('gestionBuscarPaciente');?>" style="height: auto;" target="_blank"></span> <span class="btn btn-medicine w-50 mt-2 text-left" style="padding-left:30px;padding-right:10px;z-index:1;font-size: 2rem;font-weight:bold;color: #fff;vertical-align:middle;  "> Envío de Resultado<span></a>
      </div>      
      <div class="col-md-2 text-center"></div>
     </div>
