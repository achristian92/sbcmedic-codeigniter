      ...
      <div class="row">
        <div class="col-sm">
          <div class="form-group">
            ...
            <input type="text" name="qsolicito" class="form-control" required>
          </div>
        </div>
        <div class="col-sm">
          <div class="form-group">
            <label for="hora">Email</label>
            <input type="email" name="emalqs" class="form-control" required>
          </div>
        </div>
      </div>
        ...
        <div class="col-sm">
          <div class="form-group">
            ...
            <select class="form-control" name="sede">
              ...
              <option value="DOM">Domiciliria</option>
            </select>
          </div>
        </div>
        <div class="col-sm">
                    ...
                    <table  id="lista_recetas" width="100%" class="table">
                      ...
                      <tbody>
                        <tr>
                            ...
                            <td><div class="form-group"><input type="number" name="cantidad[]" class="form-control" min="0" style="text-align: right;"></div></td>
                            <td><div class="form-group"><input type="number" name="precio[]" class="form-control" style="text-align: right;" onblur="costoTotal()" step="any" min="0"></div>
...
<!--       <div class="row">
        <div class="col-sm">
          <div class="form-group">
            <label for="pPromocionales">Pruebas Promocionales</label>
            <select class="form-control" id="pPromocionales" name="pPromocionales">
              <option value="">Seleccionar</option>
              <option value="pacmd">Prueba de Antigenos + Consulta Médica a Domicilio - S/.209</option>
              <option value="pacmdv">Prueba de Antigenos + Consulta Méd.Domic. + Consulta Méd.Virtual - S/.239</option>
            </select>
          </div>
        </div>
        <div class="col-sm">
          <div class="form-group">
            <label for="cpromocionales">Costo Promocionales</label>
            <input type="text" name="cpromocionales" class="form-control" id="cpromocionales" style=" background-color:#f2cc8f; font-weight: bold;" value="0" disabled>
          </div>
        </div>
      </div> -->
        ...
        <div class="col-sm">
          <div class="form-group">
            ...
            <select class="form-control" id="transporte" name="transporte">
              <option value="">Seleccionar</option>
              <option value="1">Aplicar precio movilidad</option>
            </select>
          </div>
        </div>
        <div class="col-sm">
      ...
      <div class="row">
        <div class="col-sm">
          <div class="form-group">
            ...
            <select class="form-control" name="tipoBanco">
              ...
              <option value="SCOTBANK">Scotiabank</option>
              <option value="INTERB">Interbank</option>
        ...
        <div class="col-sm">
          <div class="form-group">
            ...
            <input type="text" name="tCosto" class="form-control" id="tCosto" style=" background-color:#03A9F4;color:#FFF; font-weight: bold;text-align: right;" readonly>
          </div>
        </div>
      </div>
