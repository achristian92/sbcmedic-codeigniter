  ...
  <div class="container-fluid">
      ...
      <div class="row mt-2">
        ...
        <div class="col-sm">
          ...
          <table id="gestion" class="display responsive nowrap" style="width:100%;background-color:#B2EBF2;">
 ...
 -->
              ...
              ?>
                ...
                <tr>
                  ...
                  <td>
                      ...
                      <?php
                        if ($valor->id > 2 and !$valor->realizado) {
                      ?>
                  ...
                  <td><span class="badge badge-success"><?php echo substr($valor->total, 0, 6); ?></span></td>
                    <td>
                    <input type="checkbox" name="ckbPago" data-bootstrap-switch data-off-color="danger" data-on-color="success" data-on-text="SI&nbsp;&nbsp;&nbsp;" data-off-text="NO" idreg="<?php echo $valor->id;?>" <?php  if($valor->pago == 1) echo "checked='checked'"; else echo ""; ?> />  
                    </td>
         ...
         <!--            <div class="custom-control custom-checkbox">
                      ...
                      <div class="icheck-primary d-inline">
                        ...
                        <input type="checkbox" name="pendiente<?php echo $clave; ?>" id="pendiente<?php echo $clave; ?>" value="<?php echo $valor->realizado; ?>" <?php if($valor->realizado ==1) echo "checked"; ?> onClick="marcarCkeck('<?php echo $valor->id; ?>', '<?php echo $clave; ?>')"  >

                        <label for="pendiente<?php echo $clave; ?>">

                          <?php if($valor->realizado ==1) echo "SI"; else echo "No"; ?>
...
$('.ckbPago').on('switchChange.bootstrapSwitch', function(e, data) {
      $.ajax({
        type: 'post',
...
$("#especialidades").change(function(){
  ...
  /*     "order": [[ 3, "desc" ]], */
    ...
    function marcarCkeck(codigo, id) {
      ...
      $.ajax({
                ...
                url: '<?php echo base_url('gestionResumenRealizado')?>',
