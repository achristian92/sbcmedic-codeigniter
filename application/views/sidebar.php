    ...
    <div class="row">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <?php if( $this->session->userdata('idUsuario') == 548 ) { ?>
			    <li class="nav-item">
					<a href="<?php echo base_url('mis-citas-personalizado');?>" class="btn btn-warning w-100 mt-2 text-left <?php echo setActive("mis-citas-personalizado");?>">
					<i class="fab fa-searchengin"></i>
					<span class="ml-2">Busqueda Citas</span>                              
				</a>
			  </li>
		  <?php } ?>
            ...
            <li class="nav-item has-treeview menu-open mt-2">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item mt-2">
                  <a href="<?php echo base_url('cash-management-general');?>" class="nav-link <?php echo setActive("schedule");?>">
                ...
                <li class="nav-item mt-2">
                  <a href="<?php echo base_url('cash-management');?>" class="nav-link <?php echo setActive("schedule");?>">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Citas</p>
                  </a>
                </li>
