...
">
  ...
  <div class="container-fluid">
    <form method="POST" action="<?php echo base_url('actualizarGestionPaciente'); ?>" id="frmPaciente">
      ...
      <div class="row">
        <div class="col-sm">
          <div class="form-group">
            ...
            <input type="text" name="qsolicito" class="form-control" value="<?php echo $quienSolicito;?>" requerid style="text-transform: uppercase;">
          </div>
        </div>
        <div class="col-sm">
          <div class="form-group">
            <label for="hora">Email</label>
            <input type="email" name="emalqs" class="form-control" value="<?php echo $email;?>" required style="text-transform: uppercase;">
          </div>
        </div>
     ...
     <div class="row">
            ...
            <table id="lista_examenAux" width="100%" class="table" cellspacing="1" cellpadding="1">
              ...
              <tbody>
                  <?php foreach ($registros_gpc as $clave => $gpc) { ?>
                    <tr>
                      <td><input name="nombre[]" class="form-control" value="<?php echo $gpc->nombre;?>" style="text-transform: uppercase;"></td>
                      <td><input name="apellido[]" class="form-control" value="<?php echo $gpc->apellido;?>" style="text-transform: uppercase;"></td>
                      <td width="11%"><input name="dni[]" maxlength="13" class="form-control" value="<?php echo $gpc->dni;?>"></td>
                      <td><input type="email" name="email[]" class="form-control" value="<?php echo $gpc->email;?>" style="text-transform: uppercase;"></td>
                      <td width="11%"><input name="pasaporte[]" class="form-control" value="<?php echo $gpc->pasaporte;?>" style="text-transform: uppercase;"></td>
                      <td width="11%"><input name="telefonoPaciente[]" class="form-control" value="<?php echo $gpc->telefono;?>"></td>
      ...
      <div class="row">
        <div class="col-sm">
          <div class="form-group">
            ...
            <select class="form-control" id="transporte" name="transporte">
              <option value="">Seleccionar</option>
              <option value="1" <?php if($transporte == "1") echo "selected";?> >Aplicar movilidad</option>
            </select>
          </div>
        </div>
        <div class="col-sm">
          <div class="form-group">
            <label for="cTransporte">PrecioTransporte</label>
        ...
        <div class="col-sm">
          <div class="form-group">
            <label for="tCosto">TotalPrecio(S/.)</label>
        ...
        <div class="col-sm">
          <div class="form-group">
            ...
            <select class="form-control" name="tipoBanco">
              <option value="GRA" <?php if($tipo_banco == "GRA") echo "selected";?> >Gratis</option>
              <option value="EFE" <?php if($tipo_banco == "EFE") echo "selected";?> >Efectivo</option>
              <option value="TAR" <?php if($tipo_banco == "TAR") echo "selected";?> >Tarjeta</option>
              <option value="TRA" <?php if($tipo_banco == "TRA") echo "selected";?> >Transferncia</option>
 
			  <option value="CRE" <?php if($tipo_banco == "CRE") echo "selected";?> >Crédito</option>
            </select>
          </div>
        </div>
        <div class="col-sm-4">
    ...
    <tr>
      <td><input name="nombre[]" class="form-control" style="text-transform: uppercase;"></td>
    ...
    $("#quantityPsr").on('keyup change click', function () {
      ...
      $.validator.setDefaults({
        submitHandler: function() {
          Swal.fire({
            title: '¿Estás seguro de Actualizar al paciente?',
            icon: 'warning',
