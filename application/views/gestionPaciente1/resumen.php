...
<div class="custom-control custom-checkbox">
  ...
  <div class="icheck-primary d-inline">
    ...
    <input type="checkbox" name="pendiente<?php echo $clave; ?>" id="pendiente<?php echo $clave; ?>" value="<?php echo $valor->pago; ?>" <?php if($valor->pago ==1) echo "checked"; ?> onClick="marcarCkeckNew('<?php echo $valor->id; ?>', '<?php echo $clave; ?>')"  <?php if($idUsuario == 190 || $idUsuario == 228) echo ""; else echo "disabled"; ?> >
