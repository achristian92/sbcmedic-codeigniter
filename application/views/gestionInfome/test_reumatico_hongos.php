...
">
  <div class="container">
    ...
    <div class="row mt-2">
      <div class="col-sm">
        <div class="form-group">
          ...
          <input type="text" name="dato1" value="<?php echo (isset($resultados[0]->dato1))? $resultados[0]->dato1: "";?>" class="form-control" id="dato1" placeholder="Dato <?php echo $dato1;?>">
        </div>
      </div>
    </div>
    <?php } ?>
    <div class="row">
      <div class="col-sm">
        <div class="form-group">
            <label for="dato1"><?php echo $dato2;?></label>
    ...
    <div class="row">
      <div class="col-sm">
        <div class="form-group">
          <label for="dato4">Observación</label>
          <textarea name="dato4" id="" cols="3" rows="3" class="form-control" placeholder="Observación"><?php echo (isset($resultados[0]->dato4))? $resultados[0]->dato4: "";?></textarea>
        </div>
      </div>
    </div>
