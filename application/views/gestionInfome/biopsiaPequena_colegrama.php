...
">
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm">
        <div class="form-group">
          ...
          <input type="text" name="dato1" class="form-control" placeholder="Dato <?php echo $dato1;?>" value="<?php echo (isset($resultados[0]->dato1))? $resultados[0]->dato1: "";?>">
        </div>
      </div>
    </div>
    <?php } ?>
    <div class="row">
      <div class="col-sm">
        <div class="form-group">
          <label for="dato4"><?php echo $dato4;?></label>
          <textarea name="dato4" cols="2" rows="2" class="form-control" placeholder="Dato <?php echo $dato4;?>"><?php echo (isset($resultados[0]->dato4))? $resultados[0]->dato4: "";?></textarea>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-sm">
        <div class="form-group">
          <label for="observacion"><?php echo $observacion;?></label>
          <textarea name="observacion" id="" cols="2" rows="2" class="form-control" placeholder="Dato <?php echo $observacion;?>"><?php echo (isset($resultados[0]->observacion))? $resultados[0]->observacion: "";?></textarea>
        </div>
      </div>
    </div>
