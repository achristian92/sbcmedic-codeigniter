...
">
  <div class="container">
    ...
    <?php if ($idExamen == 19 || $idExamen == 59) { ?>
    <div class="row mt-2">
      <div class="col-sm">
        <div class="form-group">
          <label for="dato5"><?php echo $dato1;?></label>
            <select class="form-control" name="dato5">
                <option value="0" <?php echo (isset($resultados[0]->dato5) and $resultados[0]->dato5 == 0)? "selected" : "";?>>Negativo</option>
                <option value="1" <?php echo (isset($resultados[0]->dato5) and $resultados[0]->dato5 == 1)? "selected" : "";?>>Positivo</option>
            </select>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm">
        <div class="form-group">
          ...
          <input type="text" name="dato2" class="form-control" placeholder="<?php echo $dato2;?>" value="<?php echo (isset($resultados[0]->dato2))? $resultados[0]->dato2: "";?>">
        </div>
      </div>
    </div>
    <?php } else { ?>
    <div class="row mt-2">
      <div class="col-sm">
        <div class="form-group">
          <label for="dato5"><?php echo $dato1;?></label>
            <select class="form-control" name="dato5">
                <option value="0" <?php echo (isset($resultados[0]->dato5) and $resultados[0]->dato5 == 0)? "selected" : "";?>>No Reactivo</option>
                <option value="1" <?php echo (isset($resultados[0]->dato5) and $resultados[0]->dato5 == 1)? "selected" : "";?>>Reactivo</option>
            </select>
        </div>
      </div>
    </div>
