              ...
              <table id="misCitas" class="table table-bordered table-hover">
                  ...
                  ?>
                      <tr>
                        ...
                        <td align="center"><a href="javascript:void(0)" id="imprime" onclick="print_link('<?php echo $row->codigo_interno; ?>', '<?php echo $row->concepto; ?>', '<?php echo $row->idUsuario; ?>', '<?php echo $row->idCita; ?>', '<?php echo $this->uri->segment(5); ?>')" title="Imprimir Examen" target="_blank"><i class="fas fa-print"></i> Imprimir</a></td>
...
<script src="<?php echo base_url('plugins/select2/js/select2.full.min.js');?>"></script>
  ...
  $('.searchExamen').select2({
    ...
    function print_link(codigo, tipo, user, cita, code) {
      var mywindow = window.open('<?php echo base_url('cash-management/print_add/') ?>' + codigo + '/'+ tipo + '/' + user + '/' + cita + '/' + code, 'Imprimir', 'toolbar=1,scrollbars=1,location=1,statusbar=1,menubar=1,resizable=1,width=800,height=550,left = 390,top = 50');
