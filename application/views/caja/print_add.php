...
<!DOCTYPE html>
    <html><head> 
        ...
        <div class="container">
         <div class="row">
            <div class="col-sm">
            <a class="btn btn-primary" href="<?php echo base_url('cash-management/addPay/').$usuario."/$cita"; ?>" role="button">Volver</a> | <a href="javascript:void(0)" id="imprime"><i class="fas fa-print"></i> Imprimir</a>
            <br><br>
