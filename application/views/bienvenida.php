...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="background: transparent;">
    ...
    <section class="content">
     ...
     <div class="col-md-2 text-center"></div>
      <div class="col-md-8">
      <h5  class="text-center"><strong>MENSAJE DE BIENVENIDA</strong></h5> 
      <p>Estimado Paciente</p>
      <p>Le damos una cordial bienvenida a nuestra sistema de consulta en línea y le informamos que su cuenta de usuario ha sido creada correctamente </p>
      </div>      
      <div class="col-md-2 text-center"></div>
     </div>
