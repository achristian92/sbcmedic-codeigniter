...
?>
    ...
    <tr>
        <td colspan="2">Queremos recordarle que el día <?php echo date("d/m/Y",strtotime($row->fechaCita));?> a las <?php echo $row->horaCita;?>(Hr Lima Perú), cuenta con una consulta médica con el doctor(a) <?php echo $row->nombreMedico;?> en la especialidad de <?php echo $row->especialidad;?>. <br></td>
    </tr>
<?php if($row->tipoCita == "CV") { ?>
    <tr>
...
color:black;width: 50%;">Nombre de la sala: <strong><?php echo $row->codigoSala; ?></strong></td>
        <td style="text-align:center;font-family:arial;
font-weight:bolder;
font-size:.9rem;
text-decoration:underline;
background-color:#2AB07E;width: 50%;"><a href="<?php echo base_url('miscitas');?>" target="_blank" style="color:white;">ENLACE A LA CONSULTA</a></td>
    ...
    <table class="ablock">
        <tr>
            <td>• Nombre del paciente:</td><td><?php echo $row->nombrePaciente;?></td>
        </tr>
        <tr>
            <td>• Modo de consulta:</td><td><?php echo $row->tipoCita;?></td>
        </tr>
        <tr>
            <td>• Fecha de consulta:</td><td><?php echo date("d/m/Y",strtotime($row->fechaCita));?></td>
        </tr>
        <tr>
            <td>• Hora de consulta:</td><td><?php echo $row->horaCita;?></td>
        </tr>
        <tr>
            <td>• Especialidad:</td><td><?php echo $row->especialidad;?></td>
        </tr>
        <tr>
            <td>• Médico(a): </td><td><?php echo $row->nombreMedico;?></td>
        </tr>
        <tr>
            <td colspan="2" style="text-align:center"><strong>* La consulta podrá ser reprogramado hasta con 24 horas de anticipación al servicio.</strong></td>
        </tr>
    </table>    
