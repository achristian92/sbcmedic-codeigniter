...
">
  ...
  <div class="container-fluid">
    <form method="POST" action="<?php echo base_url('ocupacional/guardarAfiliadoHClinica'); ?>" id="frmHClinico"  enctype="multipart/form-data">
      <div class="row bg-black">
        <div class="col-sm text-center" style=" justify-content: center;align-items: center;">
          <h2>REGISTRO DEL AFILIADO - CLÍNICA OCUPACIONAL </h2>
        </div>
      </div>
        ...
        <div class="col-sm">
          <div class="form-group">
            ...
            <select class="form-control" name="cmbTipoE" id="cmbTipoE" required>
                ...
                ?>
                  <option value="<?php echo $tipoEvaluacion->id; ?>"><?php echo $tipoEvaluacion->descipcion; ?></option>
                <?php
                  }
                ?>
              </select>
      ...
      <div class="row mt-2">
        ...
        <div class="col-sm-3">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="date" name="fechaNacimiento" class="form-control" value="<?php echo date("Y-m-d"); ?>" requerid>
            </div>
          </div>
        </div>
        <div class="col-sm-3">
      ...
      <div class="row">
        ...
        <div class="col">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" id="dFiscal" name="dFiscal"  required>
            </div>
          </div>
        </div>
        <div class="col-sm-3">
      ...
      <div class="row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <select class="form-control" id="cmbGinstruccion" name="cmbGinstruccion" required>
                ...
                <option value="PRI">PRIMARIOS</option>
                <option value="SEC">SECUNDARIOS</option>
                <option value="SES">SIN ESTUDIOS</option>
              </select>
            </div>
          </div>
        </div>
        <div class="col">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" name="nTHVivos">
            </div>
          </div>
        </div>
        <div class="col">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control" name="nDependiente">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-12">
          <button type="submit" name="btnRegistrarDatos" id="btnRegistrarDatos"  class="btn btn-success btn-block">REGISTRAR AFILIADO</button>
        </div>
      </div>
    ...
    <script>
      ...
      $.validator.setDefaults({
        submitHandler: function () {
          ...
          Swal.fire({
          title: '¿ESTÁS SEGURO DE INGRESAR ESTE AFILIADO?',
            ...
            success: function (data) {
              if(data.status){  
                ...
                Swal.fire({
                  ...
                  text: data.message,
                  onClose: () => {
                    window.location.replace("<?php echo base_url('ocupacional/registroAfiliado');?>");
                  }
                })
              }else{
