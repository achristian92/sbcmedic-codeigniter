...
">
            <div class="container-fluid">
              ...
              <div class="row justify-content-md-center mt-2">
                <div class="col text-light">
                 <h5><i class="fas fa-restroom" title="Nombre del Paciente"></i> : <?php echo $usuarioCita["paciente"]." / " ; ?> <span class="badge badge-info" style="color: #000;"><i class="far fa-calendar-alt" title="Edad del Paciente"></i> <?php echo $usuarioCita["edad"]; ?></span></h5>
                </div>
              ...
              <div class="row mt-2">
                <div class="col">
                  <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" id="pills-examenesauxiliares-tab" data-toggle="pill" href="#pills-examenesauxiliares" role="tab" aria-controls="pills-examenesauxiliares" aria-selected="false">EXÁMENES AUXILIARES</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
              ...
              <div class="row justify-content-md-center">
                <div class="col ">
                  <select name="diagnostico[]" id="diagnostico" class="form-control searchCie" multiple="multiple">
                  </select>
                </div>
              </div> 
            </div>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="table-responsive">
                    <table  id="lista_recetas" style="border-spacing:5px 10px;">
                      <thead>
                        <tr>
                          ...
                          <td><button type="button" class="btn btn-success button_agregar_receta" title="Agregar registro"> <i class="fas fa-plus"></i></button></td>
                        </tr>
                      </thead>
                      <tbody>
                          <tr>
                  ...
                  <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $row->nombreProcedimiento;?></td>
                        <td style="vertical-align:middle;"><a href="javascript:ventana_cita('<?php echo $row->idCita; ?>')" title="Ver detalle de la cita"><i class="fa fa-eye" aria-hidden="true" style="font-size:36px"></i></a></td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
