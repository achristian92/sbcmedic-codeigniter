                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <?php if($realizarPago == "cambiar_status_pago" and $rol != 3) { ?>
                        <td>
                          <input type="checkbox" name="ckbPago" data-bootstrap-switch data-off-color="danger" data-on-color="success" data-on-text="SI&nbsp;&nbsp;&nbsp;" data-off-text="NO" data="<?php echo $valor["idPago"];?>" <?php  if($valor["statusPago"] == 1) echo "checked='checked'"; else echo ""; ?>  <?php if($verStatusPago == "ver_status_pago") echo "disabled"; ?>  />
                        </td>
                        <?php } ?>

                        <?php if($cerrarCita == "guardar_historia_clinica" and $rol != 3) { ?>
                          <td style="text-align: center;"><button type="button" id="btn_cierre" class="btn btn-outline-success" title="Guardar Historial" data-id="<?php echo $valor["idCita"];?>" data-usuario="<?php echo $valor["idUsuario"];?>"  data-toggle="modal" data-target="#modal-cerrarCita" <?php if($valor["statusPago"] == 0) echo "disabled"; ?> ><i class="fa fa-save" aria-hidden="true"></i></button></td>
                        <?php } ?>
                        ...
                        <?php if($cerrarCitaRapida == "cerrar_cita") { ?>
                          <td style="text-align: center;"><button type="button" id="btn_cerrar_cita" class="btn btn-warning" title="Cerrar cita" onClick="cerrarCita('<?php echo $valor["idCita"];?>')"><i class="far fa-clone"></i></button></td>
                        <?php } ?>
						<?php if($permisoCancelarCita == "cancelar_cita") { ?>
                          <td style="text-align: center;">
          ...
          <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="col-12">
                  <div class="table-responsive">
                    <table  id="lista_examenAux" width="100%" class="table">
                      ...
                      <tbody>
                        <tr>
                          <td><input name="nombreEm[]" class="form-control"></td>
                          <td><input name="especificaciones[]" class="form-control"></td>
                          <td><input name="especialidad[]" class="form-control"></td>
              ...
              <div class="row justify-content-md-center" id="descanso1" style="display:none;">
                <div class="col col-lg-12">
                  <label for="pa">Tipo de descanso</label>
                    <input name="tipoDescanso" class="form-control">
                </div>
              </div> 
              <div class="row justify-content-md-center" id="descanso2" style="display:none;">
                <div class="col col-lg-2">
                  <label for="pa">Días</label>
                    <input type="number" class="form-control" name="dias" min="1" max="20" value="1">
                  </div>
                <div class="col col-lg-5">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header d-block">
                <h4 class="modal-title text-center" id="newExamenLabel">CANCELAR CITA<button type="button" class="close" data-dismiss="modal" aria-label="Close">
